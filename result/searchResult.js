javascript: (() => {
  ...
  const dict = {
    "http://namchuncheon.co.kr/mobile/login.asp": funcLogin,
    "http://namchuncheon.co.kr/mobile/reservation_01.asp": funcReserve,
  ...
  function funcLogin() {
    ...
    if (!chk) {
      ...
      location.href = "http://namchuncheon.co.kr/mobile/reservation_01.asp";
      return;
    }
    ...
    post(
      ...
      (data) => {
        ...
        Array.from(victory.children).forEach((div) => {
          ...
          const time = str.gh(2);
          const fee_discount =
            div.children[1].str().ch(1).replace(/,/g, "") * 1;
