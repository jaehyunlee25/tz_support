...
console.clear();
    ...
    const dict = {"http://hpelichecc.co.kr/hampyeong/html/service/login.asp": funcLogin,"http://hpelichecc.co.kr/hampyeong/html/reserve/reserve01.asp": funcReserve};
    ...
    function funcLogin() {
      ...
      if (!chk) {
        ...
        location.href = "http://hpelichecc.co.kr/hampyeong/html/reserve/reserve01.asp";
        return;
      }
