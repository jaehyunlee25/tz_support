...
console.clear();
  ...
  const dict = {"http://www.seorabolgc.com/mobile/login.asp": funcLogin,"http://www.seorabolgc.com/mobile/sub03.asp": funcReserve};
  ...
  function funcLogin() {
    ...
    if (!chk) {
      ...
      location.href = "http://www.seorabolgc.com/mobile/sub03.asp?cal_month=0";
      return;
    }
...
const clubId = "c6e03d0d-e3e5-11ec-a93e-0242ac11000a";
const courses = {
  'Mountain': '4004506b-e3e9-11ec-a93e-0242ac11000a',
	'Lake': '400452b7-e3e9-11ec-a93e-0242ac11000a',
	'Hill': '400452f6-e3e9-11ec-a93e-0242ac11000a',
	'Valley': '4004532a-e3e9-11ec-a93e-0242ac11000a',
};
...
function mneCall(date, callback) {
  ...
  get("/mobile/sub03.asp", param, {}, (data) => {
