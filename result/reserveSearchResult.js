...
const dict = {
  "https://m.playersgc.com/_mobile/login/login.asp": funcLogin,
  "https://m.playersgc.com/_mobile/reservation/list.asp": funcReserve,
...
ipts[1].click();
  ...
  function funcMain() {
    ...
    location.href = "https://m.playersgc.com/_mobile/reservation/list.asp";
  }
  function funcOther() {
    log("funcOther");
